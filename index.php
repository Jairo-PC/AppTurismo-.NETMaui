...
<html lang="es">
  <head>
    ...
    <!-- Swiper CSS -->
    <link rel="stylesheet" href="css/swiper-bundle.mi.css" />
  </head>
  ...
  <body id="top">
    ...
    <header class="header" data-header>
      ...
      <div class="header-top">
        <div class="container">
          <a href="tel:+51 930 964 501" class="helpline-box">
            <div class="icon-box">
              <ion-icon name="call-outline"></ion-icon>
            </div>
            <div class="wrapper">
              <p class="helpline-title">Para más consultas:</p>
              <p class="helpline-number">+51 930 964 501</p>
            </div>
          </a>
          <a href="#" class="logo">
    ...
    <main>
            ...
            <li>
              ...
              <div class="texto">
                ...
                <p>
                  ...
                  Dolorum illum totam minus tenetur fuga? Repellat ad molestiae
                  asperiores debitis, nobis, molestias. <br />
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Dolorum illum totam minus tenetur fuga? Repellat ad molestiae
                  asperiores debitis, nobis, molestias. Lorem ipsum dolor, sit
                  amet consectetur adipisicing elit. Dolorum illum totam minus
                  tenetur fuga? Repellat ad molestiae asperiores debitis, nobis,
                  molestias. <br />
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Dolorum illum totam minus tenetur fuga? Repellat ad molestiae
                  asperiores debitis, nobis, molestias.
                </p>
                <div class="btn-group">
        ...
        <section class="news-search">
          <div class="news-title">
            ...
            <button type="button" class="image-button">
              <img
                class="white-icon"
                src="https://img.icons8.com/external-yogi-aprelliyanto-basic-outline-yogi-aprelliyanto/64/000000/external-next-multimedia-yogi-aprelliyanto-basic-outline-yogi-aprelliyanto-2.png"
                alt="external-next-multimedia-yogi-aprelliyanto-basic-outline-yogi-aprelliyanto-2"
              />
            </button>
          </div>
          <div class="container swiper news">
            ...
            <div class="swiper-button-next swiper-navBtn" style="color:black; padding:10px; background:white; width:50px;
            height:50px;"></div>
            <div class="swiper-button-prev swiper-navBtn" style="color:black; padding:10px; background:white; width:50px;
            height:50px;"></div>
      ...
      -->
        ...
        <section class="gallery" id="gallery">
          <div class="container">
            <p class="section-subtitle">Galería de fotos</p>
            <h2 class="h2 section-title">FOTOS DE LOS VIAJEROS</h2>
            <p class="section-text">
              Deja que estas imágenes te transporten a un viaje lleno de
              emociones y te inspiren a comenzar tu propia travesía.
            </p>
      ...
      -->
        ...
        <section class="restaurants">
          ...
          <div class="container swiper news">
            <div class="slide-container">
              <div class="card-wrapper swiper-wrapper">
                <div class="card-restaurante swiper-slide">
                  <div class="image-box">
        ...
        <section class="cta" id="contact">
          <div class="container">
            <div class="cta-content">
              <p class="section-subtitle">Únete a la aventura</p>

              <h2 class="h2 section-title">
                LISTO PARA UN VIAJE INOLVIDABLE. ¡RECUERDANOS!
              </h2>

              <p class="section-text">
                "Embárcate en una aventura inolvidable y descubre el mundo a
                través de tus propios ojos. sumérgete en culturas fascinantes y
                saborea la diversidad de la gastronomía local. Convierte tus
                sueños en realidad y crea recuerdos que durarán toda la vida."
              </p>
            </div>

            <button class="btn btn-secondary">Contáctenos</button>
          </div>
        </section>
      </article>
    </main>
      ...
      <div class="footer-top">
        <div class="container">
          <div class="footer-brand">
            ...
            <p class="footer-text">
              Es un sitio web dedicado a brindar a los viajeros una plataforma
              única para explorar destinos turísticos de todo el mundo y
              facilitar la planificación de sus viajes. Nuestro objetivo es
              inspirar, informar y ayudar a los viajeros a descubrir nuevas
              experiencias y crear recuerdos inolvidables.
            </p>
          </div>
            ...
            <ul>
              ...
              <li class="contact-item">
                ...
                <a href="mailto:info.tourly.com" class="contact-link"
                  >turismoninacaca@gmail.com</a
                >
              </li>
              <li class="contact-item">
                <ion-icon name="location-outline"></ion-icon>
                <address>Ninacaca, Cerro de Pasco</address>
              </li>
            </ul>
          </div>
          <div class="footer-form">
            <p class="form-text">
              ¡Suscríbase para obtener más actualizaciones y noticias!
            </p>
      ...
      <div class="footer-bottom">
        <div class="container">
          <p class="copyright">
            Desarrollado por:
            <a
              href="https://jairoperezcordova.vercel.app/"
              target="_blank"
              style="color: white"
              >Jairo Perez Cordova</a
            >.
          </p>
          <ul class="footer-bottom-list">
            <li>
              <a href="#" class="footer-bottom-link">Privacidad y politica</a>
            </li>
            <li>
              <a href="#" class="footer-bottom-link">Terminos & Condiciones</a>
            </li>
            <li>
